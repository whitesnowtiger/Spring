...
public class BController {
	...
	@Autowired											//the template obj(bean) from servlet-context.xml will go into the variable, template
	...
	public String write_view(Model model) {
		System.out.println("write_veiw()");
		
				
		return "write_view";				//just need to show where to write(the empty form)
	}
